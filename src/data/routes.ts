...
export const siteRoutes: SiteRoute[] = [
  ...
  { uk: '/history/directors/guz/', en: '/en/history/directors/guz/', titleUk: 'Олександр Миколайович Гузь', titleEn: 'Oleksandr Mykolaiovych Guz', sectionUk: 'Про інститут', sectionEn: 'About the Institute' },
