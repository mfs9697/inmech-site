...
head: "к.т.н., с.н.с. А.С. Колядюк"
headEn: "Ph.D. in Engineering, Senior Researcher A.S. Koliadiuk"
...
sectionsEn:
  - title: "Research profile"
    paragraphs:
      - "The Department of Structural Mechanics of Thin-Walled Structures conducts research on the stress-strain state, vibrations, stability and dynamics of thin-walled structures, plates and shells, including structurally heterogeneous shell systems."
    items: []
  - title: "Main research areas"
    paragraphs: []
    items:
      - "Dynamics of shells with structural features."
      - "Analysis of three-layer shells with heterogeneous filler."
      - "Influence of elastic foundations on the behaviour of shell systems."
