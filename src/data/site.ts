export const site = {
  ...
  description: "Фундаментальні та прикладні дослідження в галузі механіки деформівного твердого тіла, динаміки, стійкості, термопружності, повзучості, механіки руйнування та механіки композитних матеріалів.",
