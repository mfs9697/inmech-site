...
headEn: "Corresponding Member of the NAS of Ukraine Y.O. Zhuk"
...
sectionsEn:
  - title: "Research profile"
    paragraphs:
      - "The Department of Thermoplasticity was founded in 1972. Its scientific work is related to the mechanics of thermoviscoelastoplastic deformation and fracture of structural elements under complex non-isothermal loading processes, as well as to the development of models, algorithms and numerical methods for studying the thermomechanical behaviour of materials."
    items: []
  - title: "Main research areas"
    paragraphs: []
    items:
      - "Mechanics of thermoviscoelastoplastic deformation and fracture of structural elements under complex non-isothermal loading processes, taking into account the type of stress state."
      - "Theory of thermoviscoelastoplasticity using the third invariant of the stress deviator."
      - "Theory of thin shells and plates."
      - "Heat conduction and thermoviscoelastoplasticity of thick-walled and shell structural elements under variable thermomechanical and radiation loading."
      - "Damage problems in the structure of isotropic and orthotropic materials during deformation."
      - "Algorithms and numerical methods for studying thermoviscoelastoplastic deformation of isotropic and anisotropic structural elements."
      - "Experimental methods in the theory of thermoviscoelastoplasticity."
order: 6
