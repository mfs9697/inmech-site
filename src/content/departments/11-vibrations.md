...
headEn: "Academician of the NAS of Ukraine V.D. Kubenko"
...
sectionsEn:
  - title: "Research profile"
    paragraphs:
      - "The Department of Theory of Vibrations conducts research in the dynamics of deformable systems, acoustics, hydroelasticity, electroelasticity, contact interaction, and optimal control of the motion of rockets and spacecraft."
  - title: "Main research areas"
    items:
      - "Diffraction problems in acoustics and elasticity."
      - "Methods for studying acoustic interaction in systems of dissimilar bodies."
      - "Nonstationary interaction of structural elements with layered fluids and elastic media."
      - "Efficient methods for solving applied problems of nonstationary hydroelectroelasticity."
      - "Optimization of motion control for rockets and spacecraft."
      - "Efficient methods for solving deformation problems of anisotropic elastic and electroelastic bodies, including contact interaction and fracture mechanics under mechanical, electric, and thermal loading."
staff:
  ...
  - name: "Остос Олександр Хосейович"
    ...
    positionEn: "Senior Researcher"
    url: "/people/ostos/"
  - name: "Манафова Ольга Павлівна"
    nameEn: "Olha P. Manafova"
