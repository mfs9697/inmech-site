...
publications:
  - title: "Статті у реферованих виданнях"
    ...
    items:
      ...
      - "Селіванов М. Ф., Процан В. П. Розв’язання задачі про докритичний стан // Доповіді Національної академії наук України. 2022. № 1. С. 39–47. DOI: https://doi.org/10.15407/dopovidi2022.01.0396."
      - "Selivanov M., Bogdanov V., Altenbach H. Solving some problems of crack mechanics for a normal edge crack in orthotropic solid within the cohesive zone model approach // Mechanics of Composite Materials. 2023. Vol. 59, no. 2. P. 335–362. DOI: https://doi.org/10.1007/s11029-023-10099-67."
      - "Selivanov M., Fernati P. Determining the change of stress concentration with time in a 3-D viscoelastic transverse isotropic plate // Доповіді Національної академії наук України. 2023. № 1. С. 33–39. DOI: https://doi.org/10.17721/1812-5409.2023/2.177."
      - "Selivanov M., Fernati P. Modelling the quasistatic crack propagation in a viscoelastic orthotropic medium using the incrementalization of constitutive equations // Доповіді Національної академії наук України. 2023. № 2. С. 65–75."
  ...
  - title: "Тези доповідей та матеріали конференцій"
    ...
    items:
      ...
      - "Селіванов М. Ф., Фернаті П. В., Терещенко Л. М. Визначення траєкторії розвитку тріщину з використанням адаптивної розбивки із регулярною частиною // Механіка: сучасність і перспективи – 2024 : матеріали міжнар. наук. конф. (Київ, 7–11 жовт. 2024 р.). Київ : Ін-т механіки ім. С. П. Тимошенка НАНУ, 2024. С. 254–257."
---

Ця сторінка може містити коротку біографічну довідку, інформацію про наукову школу, участь у проєктах, організаційну роботу, керівництво аспірантами та інші відомості, які не входять до структурованих блоків вище.
