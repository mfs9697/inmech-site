...
export const siteRoutes: SiteRoute[] = [
  ...
  { uk: '/postgraduate/admission/exam-2026/', en: '/en/postgraduate/admission/exam-2026/', titleUk: 'Відеозаписи вступного іспиту 2026', titleEn: '2026 entrance examination recordings', sectionUk: 'Аспірантура', sectionEn: 'Postgraduate studies', includeInHtmlSitemap: false },
  ...
  { uk: '/library/', en: '/en/library/', titleUk: 'Бібліотека', titleEn: 'Library', sectionUk: 'Публікації', sectionEn: 'Publications' },
  { uk: '/library/monographs/', en: '/en/library/monographs/', titleUk: 'Монографії співробітників Інституту', titleEn: 'Monographs by Institute researchers', sectionUk: 'Публікації', sectionEn: 'Publications' },
  { uk: '/library/multivolume-editions/', en: '/en/library/multivolume-editions/', titleUk: 'Фундаментальні багатотомні видання', titleEn: 'Fundamental multivolume editions', sectionUk: 'Публікації', sectionEn: 'Publications' },
  { uk: '/library/textbooks/', en: '/en/library/textbooks/', titleUk: 'Підручники та навчальні посібники', titleEn: 'Textbooks and teaching aids', sectionUk: 'Публікації', sectionEn: 'Publications' },
