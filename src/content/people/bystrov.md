...
publications:
  - title: "Основні публікації"
    ...
    items:
      - >-
        Guz A.N., Kokhanenko Y.V., Bystrov V.M. Numerical investigation of the edge effect in composite laminates // Mechanics of Composite Materials. 1986. Vol. 22. P. 150–154.
      - >-
        Bystrov V.M. Analysis of the Decay of Edge Effects in Laminated Materials on the Basis of Representative Element // International Applied Mechanics. 2000. Vol. 36, No. 6. P. 826–835.
      - >-
        Коханенко Ю.В., Быстров В.М. Построение дискретных моделей на основе базовых факторов // Численные методы. Київ, 2002. С. 135–187.
      - >-
        Bystrov V.M., Dekret V.A., Zelenskii V.S. Numerical Analysis of the Edge Effect in a Composite Laminate with Compressed Reinforcement Plies // International Applied Mechanics. 2015. Vol. 51, No. 5. P. 561–566.
      - >-
      ...
      - >-
        Бистров В.М., Декрет В.А., Зеленський В.С. Крайовий ефект у шаруватому композитному матеріалі при недосконалому контакті між шарами // Проблеми обчислювальної механіки і міцності конструкцій. 2021. Вип. 33. С. 5–16.
---

**Освіта:** Київський державний університет імені Т.Г. Шевченка, спеціальність «загальна фізика», кваліфікація «фізик».
