...
- координація наукових досліджень з теоретичної і прикладної механіки та сприяння практичному використанню їх результатів;
- розвиток наукових зв’язків між установами НАН України, закладами вищої освіти та іншими організаціями, у яких працюють учені-механіки;
- розвиток міжнародної співпраці українських учених з іноземними колегами, науковими інституціями та професійними об’єднаннями;
- поширення наукової та науково-технічної інформації з механіки й популяризація результатів досліджень;
- сприяння організації наукових конференцій, симпозіумів та інших професійних форумів.

## Базова організація

Базовою організацією Комітету є Інститут механіки ім. С.П. Тимошенка НАН України. Комітет зберігає власний науково-координаційний статус і не є структурним підрозділом Інституту.
